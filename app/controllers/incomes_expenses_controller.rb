class IncomesExpensesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @incomes_expense.save
        format.html { redirect_to incomes_expense_url(@incomes_expense), notice: "Incomes expense was successfully created." }
  ...
  def update
    respond_to do |format|
      if @incomes_expense.update(incomes_expense_params)
        format.html { redirect_to incomes_expense_url(@incomes_expense), notice: "Incomes expense was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to incomes_expenses_url, notice: "Incomes expense was successfully destroyed." }
